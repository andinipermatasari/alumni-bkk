            ...
            <div class="nano">
                <div class="nano-content">
                    <ul>
                        ...
                        <li class="{{ Request::segment(1) == '/dashboard' ? 'active':'' }}"><a class="sidebar-sub-toggle"><i class="ti-home"></i> Dashboard <span class="badge badge-primary"></span></a>
                            <!-- <ul>
                        ...
                        <li class="{{ Request::segment(1) == '/dashboard' ? 'active':'' }}"><a href="/logoutadmin"><i class="ti-close"></i> Logout</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="drop-down">
                                        ...
                                        <!-- <div class="dropdown-content-body">
                                            <ul>
                                                <li>
                                                    <a href="#">
													<img class="pull-left m-r-10 avatar-img" src="assetss/images/avatar/3.jpg" alt="" />
                                                ...
                                                <div class="testimonial-widget-one owl-carousel owl-theme">
                                                    <div class="item">
                                                        <div class="testimonial-content">
                                                            ...
                                                            <img class="testimonial-author-img" src="admin/assets/images/avatar/1.jpg" alt="" />
                                    ...
                                    <!-- <div class="recent-comment m-t-15">
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"><img class="media-object" src="assetss/images/avatar/1.jpg" alt="..."></a>
                                            </div>
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"><img class="media-object" src="assetss/images/avatar/2.jpg" alt="..."></a>
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"><img class="media-object" src="assetss/images/avatar/3.jpg" alt="..."></a>
                                            </div>
                                            <div class="media-body">
